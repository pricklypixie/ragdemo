...
# 		project_indexes[proj] = load_index(index_path, backup_dir, proj, index_dir, use_sqlite, debug)
# 		
...
# 				if debug:
# 					print(f"[DEBUG] Saving {len(docs)} documents for project {proj}")
# 					if use_sqlite:
# 						print(f"[DEBUG] Using SQLite storage")
# 				
# 				index_path, backup_dir = get_index_path(index_dir, proj)
# 				
...
# 							dimension = len(doc.embedding)
# 							break
# 					print(f"[DEBUG] First document embedding dimension: {dimension}")
# 				
# 				# Save the documents
# 				save_index(docs, index_path, backup_dir, proj, index_dir, use_sqlite, debug)
# 
# 			
